    ...
    <nav
      ...
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
        <NuxtLink to="/" @click="selectedLink('')">
          <img class="h-20 w-20  logo rounded-3xl" src="/alpha.png" alt="Store logo" />
        </NuxtLink>
        ...
        <div class="flex md:order-2">
          ...
          <div v-if="isLoggedIn" class="grid grid-cols-2 items-center">
            ...
            <div class="col-span-1" v-if="isLoggedIn">
              <div class="relative group">
                <button @click="toggleDropdown"
                  class="flex p-2 items-center space-x-2 focus:outline-none border border-cyan-500 rounded-md font-medium">
            ...
            <NuxtLink to="/createPost" type="button" @click="selectedLink('')"
              class="max-w-max py-2 px-3 ml-3 bg-transparent hover:bg-green-500 text-green-400 font-semibold hover:text-white border border-green-500 hover:border-transparent rounded-lg">
              Đăng bài
            </NuxtLink>
        ...
        <div class="flex gap-5  items-center">
          <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
            <ul
              ...
              <NuxtLink to="/" class="block py-2 pl-3 pr-4 rounded md:p-0 md:dark:text-blue-500"
                :class="{ 'bg-slate-200 text-black py-2 px-2 ': activeLink === 'home' }" @click="selectedLink('home')">
                Home</NuxtLink>
              <NuxtLink to="/search/rent" class="block py-2 pl-3 pr-4 rounded md:p-0 md:dark:text-blue-500"
                :class="{ 'bg-slate-200 text-black ': activeLink === 'rent' }" @click="selectedLink('rent')">
                Cho thuê</NuxtLink>
              <NuxtLink to="/search/sell" class="block py-2 pl-3 pr-4 rounded md:p-0 md:dark:text-blue-500"
                :class="{ 'bg-slate-200 text-black ': activeLink === 'sell' }" @click="selectedLink('sell')">
                Bán</NuxtLink>
              <NuxtLink to="/allPost" class="block py-2  rounded md:p-0 md:dark:text-blue-500"
                :class="{ 'bg-slate-200 text-black px-3 ': activeLink === 'allPost' }" @click="selectedLink('allPost')">
