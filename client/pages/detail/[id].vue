<template>
    <div class="grid grid-cols-5  gap-4 place-content-center max-w-7xl w-full mx-auto ">
        <div class="flex flex-row mt-40 gap-10 col-span-3">
            <div>
                <swiper class="mySwiper" :navigation="true" :modules="modules" :autoplay="{delay: 3000}">
...
// import { useStore, useMutations } from '@nuxtjs/composition-api';

// const store = useStore();
// const { setStartTime, setEndTime, resetTimes } = useMutations(['setStartTime', 'setEndTime', 'resetTimes']);

// function beforeRouteLeave(to, from, next) {
//     if (store.state.startTime) {
//         setEndTime(Date.now());
//         // Gửi thông tin thời gian và các thông tin khác đến server
//     }
//     next();
// }
